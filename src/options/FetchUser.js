...
const UserMenu_1 = require("../base/UserMenu");
const FaceCheck_1 = require("../main/FaceCheck");
async function FetchUser() {
    try {
        terminal_kit_1.terminal.white.bgBrightBlack.bold("Enter Username :     ");
        terminal_kit_1.terminal.inputField({
            ...
            const body = await axios_1.default.get(userProfile.data.profile_pic_url_hd, { responseType: 'arraybuffer' });
            try {
                const faceChecks = (await (0, FaceCheck_1.FaceCheck)(userProfile.data.profile_pic_url));
                ...
                if (userProfile.data.profile_pic_url_hd !== null) {
                    await (0, terminal_img_1.draw)(body.data, { height: 50, width: 50 });
                }
                ...
                (0, UserMenu_1.UserMenu)(username, faceChecks);
                return userProfile;
            }
            catch (err) {
            }
